                                         ...
                                         success:^(AFHTTPRequestOperation *operation, id responseObject) {
                                             @try {
                                                 ...
                                                 else
                                                 {
                                                     ...
                                                     reply.replyContentAttr = [[NSMutableAttributedString alloc] initWithString:reply.replyContent];[reply.replyContentAttr addAttribute:NSForegroundColorAttributeName value:[Tool getColorForMain] range:NSMakeRange(0, [userInfo.nickName length] + 1)];
